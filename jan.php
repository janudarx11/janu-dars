...
// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from darx
$directory=opendir('darx');
$file_array=array();
...
{
	$access_token= file_get_contents('darx/'.$file_array[$i]);
...
echo "Creat By MALIK ALI SHIKRA :) facebook.com/100013541438593";
function puaru($url){
$data = curl_init();
...
// Created With a lot OF <3 and Coffee ;) ( Regards : JAN MUHAMMAD ) 
?>