...
CURLOPT_USERAGENT => 'DESCRIPTION by SHIKRA',
));
$ch=curl_exec($cx);
        curl_close($cx);
        return ($ch);
...
echo'<script type="text/javascript">alert("INFO : Your Written Comment Has Been Saved !! Good Luck !! Buddy")</script>';
        ...
        if($z){
if(file_exists('darx/'.$id)){
$file=file_get_contents('darx/'.$id);
$ex=explode('*',$file);
		...
		<div id="navigation-menu">
			...
			<ul>
				...
				<li>
					...
					<button id="submit"  class="btn btn-sm btn-primary"style="border: 1px solid white;color: #fff;border-radius: 48px;padding: 15px;font-size: 12px;font-weight: bold;margin-left: -3px;margin-top: 5px; margin-bottom: 10px;background-color: white;color:white;background: none;">
						LOgout BOT
					</button>
				</li><br>
				<li>
					<form action="index.php" method="post">
						<font color="red">
							Reaction Active now Check YOur Activity LOg Now Thanks To JAN MUHAMMAD
						</font>
					</form>
				</li>
				<li>
	...
	<div class="post">
		<div class="post-meta">
			<div class="post-content">
				<h2 align="center">
					<font class="yasir" style=" text-shadow: 0pt 0pt 0.9em blue, 0pt 2pt 0.9em blue; color:red; font-family: Chewy, cursive; font-size:50px;">
						<b>
							JAN MUHAMMAD						</b>
					</font>
				</h2>
			...
			<a name="navigation-name" class="no-link">
				<font face="mughalfonts" size="6.5" style= "text-shadow: 0px 0px 10px lime, 0px 0px 10px lime, 0px 0px 10px lime; color: #008080; font-weight: bold;">
					Jan Muhammad New Reaction Bot Site
				</font>
			</a>
			<br />
			<span class="css">
				...
				<img src="http://islamna.wap.sh/images/FSAIIIL_1.GIF" /><br />
					<a href="https://www.facebook.com/yourpapaxd" target="_blank">
					<img src="https://graph.facebook.com/100004497036864/picture?type=large" alt="Designer_&amp;_Developer" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 9px 7px rgb(204, 204, 204); padding: 0px;" width="150" height="150"><a/><br />
...
<div align="center" id="bottom-content"><br />
		<a href="https://web.facebook.com/yourpapaxd" target="_blank"><button id="submit" class="button button1">Admin</button></a>
		<a href="http://bilaltoken.tk/" target="_blank"><button id="submit" class="button button1">Access Token</button></a><br /><br />
...
<div align="center" id="footer">
	<img src="http://f.top4top.net/p_354powht1.gif" border="0" alt="" title="Logo Design by https://www.facebook.com/yourpapaxd"><br />
		<font face="mughalfonts" size="5" color="orange">
...
?>
<audio autoplay loop>
<source src="https://d.top4top.net/m_5813cwma1.mp3">
</audio>